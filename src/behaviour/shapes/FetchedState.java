...
class FetchedState implements ShapeState {
	...
	public final void handle() {
		...
		if (player.getCharacter().getLeftStack().size() >= 3 && player.getCharacter()
				.getLeftStack().peek().equals(context.getShape())) {
			...
			if (shape1.getColor().equals(shape2.getColor()) && shape1.getColor()
		...
		if (player.getCharacter().getRightStack().size() >= 3 && player.getCharacter()
				.getRightStack().peek().equals(context.getShape())) {
